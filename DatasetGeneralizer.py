...
class DatasetGeneralizer():
    ...
    def duplicate_dataset(self, num_initial_files, expected_num_of_files, initial_file_name, copy_file_name, initial_file_extension='jpeg', copy_file_extension='jpeg'):
